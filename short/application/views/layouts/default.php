<?php
	$titulo      = "Pase laboral minedu";
	$this->ci    = &get_instance();
	$ses         = $this->session->userdata("ses");
	$per_noc     = $ses['usu_mostrar'];
...
<head>
	...
	<link rel="icon" type="image/png" href="<?= base_url('template/assets/img/logo.png') ?>">
	<title><?= $titulo ?></title>
	<!--Core CSS -->
	...
	<link rel="stylesheet" href="<?= base_url("template/assets/vendor/libs/datatables/datatables.css") ?>">
	<link rel="stylesheet" href="<?= base_url("template/assets/vendor/libs/select2/select2.css") ?>">
	<link rel="stylesheet" href="<?= base_url("template/assets/vendor/libs/bootstrap-daterangepicker/bootstrap-daterangepicker.css") ?>">
	<!--Core CSS -->
	<?= $this->layout->css; ?>
	<!-- Load polyfills -->
		...
		<div id="layout-sidenav" class="layout-sidenav sidenav sidenav-vertical bg-dark">
			...
			<div class="app-brand demo">
				...
				<a href="<?= base_url();?>" class="app-brand-text demo sidenav-text font-weight-normal ml-2">
					<img src="<?= base_url("template/assets/img/logo-minedu.png")?>" width="150px" alt="logo" title="logo"/>
				</a>
				...
				<li class="sidenav-item open active">
					...
					<ul class="sidenav-menu">
						<li class="sidenav-item active">
							<a href="<?= base_url('Organos/index');?>" class="sidenav-link">
								<div>Órganos</div>
							</a>
						</li>
						<li class="sidenav-item">
							<a href="<?= base_url('Locales/index');?>" class="sidenav-link">
								<div>Locales</div>
							</a>
						</li>
<!--						<li class="sidenav-item">-->
              ...
              <svg viewBox="0 0 148 80" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><defs><linearGradient id="a" x1="46.49" x2="62.46" y1="53.39" y2="48.2" gradientUnits="userSpaceOnUse"><stop stop-opacity=".25" offset="0"></stop><stop stop-opacity=".1" offset=".3"></stop><stop stop-opacity="0" offset=".9"></stop></linearGradient><linearGradient id="e" x1="76.9" x2="92.64" y1="26.38" y2="31.49" xlink:href="#a"></linearGradient><linearGradient id="d" x1="107.12" x2="122.74" y1="53.41" y2="48.33" xlink:href="#a"></linearGradient></defs><path style="fill: #fff;" transform="translate(-.1)" d="M121.36,0,104.42,45.08,88.71,3.28A5.09,5.09,0,0,0,83.93,0H64.27A5.09,5.09,0,0,0,59.5,3.28L43.79,45.08,26.85,0H.1L29.43,76.74A5.09,5.09,0,0,0,34.19,80H53.39a5.09,5.09,0,0,0,4.77-3.26L74.1,35l16,41.74A5.09,5.09,0,0,0,94.82,80h18.95a5.09,5.09,0,0,0,4.76-3.24L148.1,0Z"></path><path transform="translate(-.1)" d="M52.19,22.73l-8.4,22.35L56.51,78.94a5,5,0,0,0,1.64-2.19l7.34-19.2Z" fill="url(#a)"></path><path transform="translate(-.1)" d="M95.73,22l-7-18.69a5,5,0,0,0-1.64-2.21L74.1,35l8.33,21.79Z" fill="url(#e)"></path><path transform="translate(-.1)" d="M112.73,23l-8.31,22.12,12.66,33.7a5,5,0,0,0,1.45-2l7.3-18.93Z" fill="url(#d)"></path></svg>
				...
				<div class="navbar-collapse collapse" id="layout-navbar-collapse">
					...
					<div class="navbar-nav align-items-lg-center ml-auto">
						...
						<div class="demo-navbar-messages nav-item dropdown mr-lg-3" style="display: none">
							...
							<div class="dropdown-menu dropdown-menu-right">
								...
								<div class="list-group list-group-flush">
									<a href="javascript:void(0)" class="list-group-item list-group-item-action media d-flex align-items-center">
										<img src="<?= base_url("template/assets/img/avatars/6-small.png")?>" class="d-block ui-w-40 rounded-circle" alt>
									...
									<a href="javascript:void(0)" class="list-group-item list-group-item-action media d-flex align-items-center">
										<img src="<?= base_url("template/assets/img/avatars/4-small.png")?>" class="d-block ui-w-40 rounded-circle" alt>
										<div class="media-body ml-3">
									...
									<a href="javascript:void(0)" class="list-group-item list-group-item-action media d-flex align-items-center">
										<img src="<?= base_url("template/assets/img/avatars/5-small.png")?>" class="d-block ui-w-40 rounded-circle" alt>
										<div class="media-body ml-3">
											<div class="text-body line-height-condenced">Sit meis deleniti eu, pri vidit meliore docendi ut.</div>
											<div class="text-light small mt-1">
									...
									<a href="javascript:void(0)" class="list-group-item list-group-item-action media d-flex align-items-center">
										<img src="<?= base_url("template/assets/img/avatars/11-small.png")?>" class="d-block ui-w-40 rounded-circle" alt>
										<div class="media-body ml-3">
                  ...
                  <span class="d-inline-flex flex-lg-row-reverse align-items-center align-middle">
                    <img src="<?= base_url("template/assets/img/avatars/1.png")?>" alt class="d-block ui-w-30 rounded-circle">
...
<script src="<?= base_url("template/assets/vendor/libs/chartjs/chartjs.js") ?>"></script>

<script src="<?= base_url("template/assets/vendor/libs/sparkline/sparkline.js") ?>"></script>
<script src="<?= base_url("template/assets/vendor/libs/datatables/datatables.js") ?>" type="text/javascript"></script>
<script src="<?= base_url("template/assets/vendor/libs/moment/moment.js") ?>"></script>
<script src="<?= base_url("template/assets/vendor/libs/bootstrap-daterangepicker/bootstrap-daterangepicker.js") ?>"></script>
...
<script src="<?= base_url("template/assets/js/validaciones.js") ?>"></script>
<?= $this->layout->js; ?>
<!--common script init for all pages-->
<script src="<?= base_url("template/assets/js/demo.js") ?>"></script>
<!--	<script src="--><?//= base_url("template/assets/js/dashboards_dashboard-2.js") ?><!--"></script>-->
<script>
